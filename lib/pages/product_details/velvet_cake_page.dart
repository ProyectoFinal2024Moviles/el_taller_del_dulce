...
class velvetCakePage extends StatefulWidget {
  const velvetCakePage({super.key});

  @override
  State<velvetCakePage> createState() => _velvetCakePageState();
}

class _velvetCakePageState extends State<velvetCakePage> {
  final String cake = 'assets/images/red_velvet_cake.jpg';
  final String description = "Deliciosa torta de red velvet";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta de Red Velvet ($_selectedSize)',
            image: cake,
