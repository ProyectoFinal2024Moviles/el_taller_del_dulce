...
class tresLechesChocolateCakePage extends StatefulWidget {
  const tresLechesChocolateCakePage({super.key});

  @override
  State<tresLechesChocolateCakePage> createState() =>
      _tresLechesChocolateCakePageState();
}

class _tresLechesChocolateCakePageState
    extends State<tresLechesChocolateCakePage> {
  final String cake = 'assets/images/treslechesChocolate.jpg';
  final String description = "Deliciosa torta tres leches de chocolate";

  final Map<String, double> cakePrices = {
    'Pequeño': 25000.0,
    'Mediano': 40000.0,
    'Grande': 55000.0,
    'Extra Grande': 85000.0,
  };
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Tres Leches de Chocolate ($_selectedSize)',
            image: cake,
