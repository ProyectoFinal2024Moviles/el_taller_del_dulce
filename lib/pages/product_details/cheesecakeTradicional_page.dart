...
class CheesecakeTradicionalPage extends StatefulWidget {
  const CheesecakeTradicionalPage({super.key});

  @override
  State<CheesecakeTradicionalPage> createState() =>
      _CheesecakeTradicionalPageState();
}

class _CheesecakeTradicionalPageState extends State<CheesecakeTradicionalPage> {
  final String cake = 'assets/images/postrecheesecake.jpg';
  final String description = "Delicioso y cremoso cheesecake de mora";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'CheeseCake de Mora ($_selectedSize)',
            image: cake,
