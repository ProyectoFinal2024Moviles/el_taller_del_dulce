...
class tresLechesCarameloCakePage extends StatefulWidget {
  const tresLechesCarameloCakePage({super.key});

  @override
  State<tresLechesCarameloCakePage> createState() =>
      _tresLechesCarameloCakePageState();
}

class _tresLechesCarameloCakePageState
    extends State<tresLechesCarameloCakePage> {
  final String cake = 'assets/images/caramelo_cake.jpg';
  final String description = "Deliciosa torta tres leches de caramelo";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Tres Leches de Caramelo ($_selectedSize)',
            image: cake,
