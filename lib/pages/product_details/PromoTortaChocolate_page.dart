...
class PromoTortaChocolatePage extends StatefulWidget {
  const PromoTortaChocolatePage({super.key});

  @override
  State<PromoTortaChocolatePage> createState() =>
      _PromoTortaChocolatePageState();
}

class _PromoTortaChocolatePageState extends State<PromoTortaChocolatePage> {
  final String cake = 'assets/images/chocolate_cake.jpg';
  final String description = "Deliciosa promo de torta de chocolate";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta de Chocolate ($_selectedSize)',
            image: cake,
