...
class SouffleSinLechePage extends StatefulWidget {
  const SouffleSinLechePage({super.key});

  @override
  State<SouffleSinLechePage> createState() => _SouffleSinLechePageState();
}

class _SouffleSinLechePageState extends State<SouffleSinLechePage> {
  final String cake = 'assets/images/souffle.jpg';
  final String description = "Delicioso y cremoso soufflé de chocolate";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Soufflé de Chocolate ($_selectedSize)',
            image: cake,
