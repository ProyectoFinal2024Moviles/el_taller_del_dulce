...
class JugoNaranjaDrinkPage extends StatefulWidget {
  const JugoNaranjaDrinkPage({super.key});

  @override
  State<JugoNaranjaDrinkPage> createState() => _JugoNaranjaDrinkPageState();
}

class _JugoNaranjaDrinkPageState extends State<JugoNaranjaDrinkPage> {
  final String cake = 'assets/images/jugoNaranja.jpeg';
  final String description = "Delicioso, natural y refrescante jugo de naranja";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Jugo de Naranja ($_selectedSize)',
            image: cake,
