...
class CocaColaDrinkPage extends StatefulWidget {
  const CocaColaDrinkPage({super.key});

  @override
  State<CocaColaDrinkPage> createState() => _CocaColaDrinkPageState();
}

class _CocaColaDrinkPageState extends State<CocaColaDrinkPage> {
  final String cake = 'assets/images/cocacola.png';
