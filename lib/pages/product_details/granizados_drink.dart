...
class GranizadoDrinkPage extends StatefulWidget {
  const GranizadoDrinkPage({super.key});

  @override
  State<GranizadoDrinkPage> createState() => _GranizadoDrinkPageState();
}

class _GranizadoDrinkPageState extends State<GranizadoDrinkPage> {
  final String cake = 'assets/images/granizado.jpg';
  final String description = "Delicioso y refrescante granizado de café";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Granizado de Café ($_selectedSize)',
            image: cake,
