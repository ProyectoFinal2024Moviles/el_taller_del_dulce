...
class tresLechesMiloCakePage extends StatefulWidget {
  const tresLechesMiloCakePage({super.key});

  @override
  State<tresLechesMiloCakePage> createState() => _tresLechesMiloCakePageState();
}

class _tresLechesMiloCakePageState extends State<tresLechesMiloCakePage> {
  final String cake = 'assets/images/milo_cake.jpg';
  final String description = "Deliciosa torta tres leches de milo";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Tres Leches de Milo ($_selectedSize)',
            image: cake,
