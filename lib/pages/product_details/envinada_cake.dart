...
class envinadaCakePage extends StatefulWidget {
  const envinadaCakePage({super.key});

  @override
  State<envinadaCakePage> createState() => _envinadaCakePageState();
}

class _envinadaCakePageState extends State<envinadaCakePage> {
  final String cake = 'assets/images/envinada_cake.jpg';
  final String description = "Deliciosa torta de envinada";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Envinada ($_selectedSize)',
            image: cake,
