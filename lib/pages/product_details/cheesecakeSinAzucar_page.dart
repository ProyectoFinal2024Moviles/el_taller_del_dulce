...
class CheesecakeSinAzucarPage extends StatefulWidget {
  const CheesecakeSinAzucarPage({super.key});

  @override
  State<CheesecakeSinAzucarPage> createState() =>
      _CheesecakeSinAzucarPageState();
}

class _CheesecakeSinAzucarPageState extends State<CheesecakeSinAzucarPage> {
  final String cake = 'assets/images/postresSinAzucar.jpg';
  final String description = "Delicioso y cremoso cheesecake de piña";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'CheeseCake de Piña ($_selectedSize)',
            image: cake,
