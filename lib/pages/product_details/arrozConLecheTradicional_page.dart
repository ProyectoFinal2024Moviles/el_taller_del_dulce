...
class ArrozconlechetradicionalPage extends StatefulWidget {
  const ArrozconlechetradicionalPage({super.key});

  @override
  State<ArrozconlechetradicionalPage> createState() =>
      _ArrozconlechetradicionalPageState();
}

class _ArrozconlechetradicionalPageState
    extends State<ArrozconlechetradicionalPage> {
  final String cake = 'assets/images/Arroz-Con-Leche.jpg';
