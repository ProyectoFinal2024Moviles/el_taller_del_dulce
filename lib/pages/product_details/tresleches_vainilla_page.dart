...
class tresLechesVainillaCakePage extends StatefulWidget {
  const tresLechesVainillaCakePage({super.key});

  @override
  State<tresLechesVainillaCakePage> createState() =>
      _tresLechesVainillaCakePageState();
}

class _tresLechesVainillaCakePageState
    extends State<tresLechesVainillaCakePage> {
  final String cake = 'assets/images/treslechesVainilla.jpg';
  final String description = "Deliciosa torta tres leches de vainilla";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Tres Leches de Vainilla ($_selectedSize)',
            image: cake,
