...
class sinAzucarFresaPage extends StatefulWidget {
  const sinAzucarFresaPage({super.key});

  @override
  State<sinAzucarFresaPage> createState() => _sinAzucarFresaPageState();
}

class _sinAzucarFresaPageState extends State<sinAzucarFresaPage> {
  final String cake = 'assets/images/sinazucar.jpeg';
  final String description = "Deliciosa torta de fresa sin azucar";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta de Fresa ($_selectedSize)',
            image: cake,
