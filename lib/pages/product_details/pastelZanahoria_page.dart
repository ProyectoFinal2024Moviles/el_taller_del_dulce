...
class pastelZanahoriaSinLechePage extends StatefulWidget {
  const pastelZanahoriaSinLechePage({super.key});

  @override
  State<pastelZanahoriaSinLechePage> createState() =>
      _pastelZanahoriaSinLechePageState();
}

class _pastelZanahoriaSinLechePageState
    extends State<pastelZanahoriaSinLechePage> {
  final String cake = 'assets/images/postresSinLactosaZanahoria.jpg';
  final String description = "Delicioso y cremoso pastelito de zanahoria";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Pastelito de Zanahoria ($_selectedSize)',
            image: cake,
