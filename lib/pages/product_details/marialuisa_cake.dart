...
class marialuisaCakePage extends StatefulWidget {
  const marialuisaCakePage({super.key});

  @override
  State<marialuisaCakePage> createState() => _marialuisaCakePageState();
}

class _marialuisaCakePageState extends State<marialuisaCakePage> {
  final String cake = 'assets/images/marialuisa_cake.jpg';
  final String description = "Deliciosa torta Maria Luisa";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Torta Maria Luisa ($_selectedSize)',
            image: cake,
