...
class FlanSinAzucarPage extends StatefulWidget {
  const FlanSinAzucarPage({super.key});

  @override
  State<FlanSinAzucarPage> createState() => _FlanSinAzucarPageState();
}

class _FlanSinAzucarPageState extends State<FlanSinAzucarPage> {
  final String cake = 'assets/images/postresSinAzucarFlan.jpg';
  final String description = "Delicioso flan de calabaza";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CarPage(
          cartItem: CartItem(
            name: 'Flan de Calabaza ($_selectedSize)',
            image: cake,
